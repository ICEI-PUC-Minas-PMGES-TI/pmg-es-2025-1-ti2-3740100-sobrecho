					...
					<FormItem>
						...
						<FormControl>
							<div className="flex items-center gap-3">
								...
								<label
									htmlFor="store-image"
									className="border-input bg-foreground/5 placeholder:text-muted-foreground hover:bg-foreground/10 focus-visible:ring-ring flex h-8 flex-1 cursor-pointer items-center gap-2 rounded-md border px-2.5 py-1 text-sm shadow-sm transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
								>
